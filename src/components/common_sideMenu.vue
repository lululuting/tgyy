      ...
      <div class="menu_box animated">
          ...
          <div class="nav_con">
              <ul class="nav_list">
                  ...
                  <li class="waves-effect waver-button"><a href=""><i class="iconfont icon-location"></i>我的位置</a></li>
              ...
              <ul class="nav_list">
                ...
                <li class="waves-effect waver-button"><a href=""><i class="iconfont icon-peoplelist"></i>车队</a></li>
      ...
      .side_menu{
          ...
          .menu_box{
              ...
              .user_box{
                  ...
                  background: url('../assets/images/user_box_bg_0123asd.png') $themeColor no-repeat;
